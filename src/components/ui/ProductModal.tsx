...
export default function Modal() {
  return (
    <Fragment>
      <label
        htmlFor="my-modal-3"
        className="text-[#04512A] md:text-lg text-base underline underline-offset-2 self-center btn bg-white border-none font-normal hover:bg-white"
      >
        詳細
      </label>
